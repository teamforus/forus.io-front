...
app.component('modalVoucherDeactivateComponent', require('./components/Modals/ModalVoucherDeactivateComponent'));
app.component('modalVoucherDeactivationConfirmComponent', require('./components/Modals/ModalVoucherDeactivationConfirmComponent'));
